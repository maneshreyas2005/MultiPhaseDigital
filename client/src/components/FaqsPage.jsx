...
// import useInView from "./UseInView"; // import your hook
...
//                     src={vector6}
//                     alt="Decorative line"
//                     className={`w-[250px] sm:w-[300px] md:w-[300px] mt-4 sm:mt-5 md:mt-[20px] mx-auto md:ml-[8rem] lg:ml-[30rem] mb-4 sm:mb-5 md:mb-[20px] 
//                         ${headingVisible ? "animate-fade-slide-up" : "opacity-0"}`}
//                 />
//             </div>
...
//                         key={index}
//                         ref={faqRef}
//                         className={`bg-gradient-to-r w-[800px] from-pink-500 via-purple-500 to-pink p-[2px] rounded-lg mb-4 transition-all duration-500
...
//                             <span className="w-[500px] text-white">{faq.question}</span>
            ...
            <div className="flex flex-col items-center w-full">
                {faqs.map((faq, index) => {
                    ...
                    return (
                        ...
                        >
                            {/* Inner Box */}
                            <div className="bg-black rounded-lg p-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
