...
//                     return (
//                         <div key={index} className="w-full max-w-[800px] mb-4">
//                             {/* Question Block with Gradient */}
//                             <div
//                                 ref={faqRef}
//                                 className={` bg-gradient-to-r from-pink-500 via-purple-500 to-pink p-[2px] rounded-lg transition-all duration-500
//             ${faqVisible ? "animate-slide-to-left" : "opacity-0 translate-x-10"}`}
//                             >
//                                 <div className="bg-black rounded-lg p-4 flex sm:flex-row sm:justify-between sm:items-center gap-3">
//                                     <span className="text-gray-300 flex-shrink-0">Q{index + 1}</span>
...
//                                 </div>
//                             </div>
//                             {/* Answer Block WITHOUT Gradient */}
//                             {isOpen && (
                                
//                                 <div className="bg-black p-4  text-gray-300 text-sm sm:text-base rounded-b-lg">
//                                     ➡️{faq.answer}
//                                 </div>
//                             )}
//                         </div>
