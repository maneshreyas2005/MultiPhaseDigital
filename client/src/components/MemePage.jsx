    ...
    <div className="relative w-full bg-black flex items-center justify-center overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="relative z-10 flex flex-col items-center">
          <h1
            ref={headingRef}
            className={`text-white text-3xl md:text-6xl font-bold tracking-wide mb-2 mt-[22px] ${
              isHeadingVisible ? "animate-word-reveal" : ""
            }`}
            style={{ fontFamily: "Constantine" }}
          >
            <span className=" sm:text-3xl md:text-4xl lg:text-5xl ml-[36px]">
              MEME PAGE
            </span>{" "}
            <br />{" "}
            <span className="text-1xl sm:text-3xl md:text-4xl lg:text-5xl ml-[35px] md:ml-[36px]">
              MARKETING
            </span>
          </h1>
          <img
        ...
        <div
          ref={imagesRef}
          className="relative grid grid-cols-2 md:grid-cols-4 gap-10 md:top-[-170px] pl-[1rem] pr-[1rem]"
        >
          <img
            src={OnePlus10t}
            alt="Phone 1"
