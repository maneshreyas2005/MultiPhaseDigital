...
const MediaFeature = () => {
    ...
    return (
        ...
        >
            {/* Heading */}
            <div
                className={`text-center mb-8 sm:mb-10 md:mb-12 ${sectionInView ? 'animate-slide-up' : 'opacity-0'}`}
            ...
            >
                <button
                    className="relative px-6 sm:px-8 py-3 sm:py-4 w-[200px] sm:w-[250px] md:w-[300px] rounded-full mb-4 sm:mb-5 bg-black text-white font-medium text-base sm:text-lg tracking-wide hover:scale-105 transition-transform duration-200"
                >
                    <img src={NEWSchannelButton} alt="" className="absolute mt-[-10px]" />
                </button>
            </div>
