...
const testimonials = [
  ...
  },
  {
    ...
    avatar:
      "https://yt3.googleusercontent.com/9GYCn_PuL97R-A0OjzO7ykK5rX_KCm7lXLJ7cA6i3rvBvlpszIo-oFe3xp-UJ2eNUqVZEHXgbw=s120-c-k-c0x00ffffff-no-rj",
    rating: 5,
  },
];
...
const TestimonialCard = ({ testimonial }) => {
  return (
    <div
      className="relative bg-transparent rounded-[2rem] p-6 mb-6 border border-gray-700/30 shadow-2xl 
    ...
    >
      <div
        className="absolute -bottom-4 -right-[0.1rem] md:-bottom-9 md:-right-1 
      ...
      <div className="relative z-10 rounded-[4rem] ">
        <p
          className="text-gray-300 xl:mt-[2rem] w-full sm:w-[90%] md:w-[95%] 
      ...
      <div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-600/0 via-blue-600/0 to-purple-600/0 
...
const ScrollingTestimonials = () => {
  ...
  return (
    <div
      id="Testimonial"
      className="relative min-h-screen bg-black py-10 px-8 md:py-20 md:px-30 lg:mt-[-7rem] overflow-hidden"
      style={{}}
    >
