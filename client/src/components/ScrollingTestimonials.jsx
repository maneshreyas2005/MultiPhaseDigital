...
//                         >
//                         <span className="text-4xl">CLIENT REVIEWS</span> <br /> <span className="text-4xl ml-[36px] mt-[-50px]">WE WORKED HARD TO SATISFY OUR CLIENTS</span>
//                             </h1>
//                             <img
//                                 src={vector6}
//                                 alt="Decorative line"
//                                className="w-[400px] md:w-[350px] mb-8"
//                                 />
//                 </div> */}
//                 <div className="relative z-10 flex flex-col items-center">
//                     <h1
...
//                         style={{ fontFamily: 'Constantine' }}
//                     >
//                         <span className="text-center">CLIENT REVIEWS</span>
//                         <span className="text-center text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl mt-2 sm:mt-1 md:mt-0 lg:mt-[-50px] lg:ml-[36px]">
