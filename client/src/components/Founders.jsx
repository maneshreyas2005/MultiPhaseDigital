      ...
      <div className="hidden lg:flex flex-col relative justify-center items-center  mt-[-4rem] bg-black px-4 sm:px-6 lg:px-8 overflow-hidden z-[0]">
        <div className="flex mt-[-3rem] gap-6 lg:gap-10 xl:gap-15 ml-7 absolute z-[1]">
          <span className="text-white/40 text-lg lg:text-xl xl:text-2xl font-semibold tracking-wide  whitespace-normal">
            <span className="text-white text-right text-lg lg:text-xl xl:text-2xl font-semibold tracking-wide text-center">
              MEHUL PUROHIT
            </span>
            <br />
            Founder & CEO
        ...
        <div className="flex gap-6 lg:gap-[14rem] xl:gap-[25rem] relative">
          <div
            className={`flex items-center gap-4 lg:gap-6 ${isInView ? "animate-slide-in-right" : ""}`}
          >
            <img
              src={Founder2}
              alt="Mehul Purohit"
              className="w-[320px] lg:w-[380px] xl:w-[420px]  h-auto rounded-lg object-contain grayscale"
            />
          </div>
          <div
            className={`flex items-center xl:gap-6 ${isInView ? "animate-slide-in-left" : ""}`}
          >
            <img
              src={DevendraPurohit}
              alt="Anubhav Dubey"
              className="w-[280px] lg:w-[340px] xl:w-[420px] h-auto rounded-lg object-contain"
            />
          </div>
        </div>
      </div>
        ...
        <div className="flex gap-6 lg:gap-[17rem] xl:gap-[23rem] relative">
          ...
          >
            <img
              src={Founder4}
              alt="Sameer Satyarth"
              className="w-[280px] lg:w-[500px] xl:w-[600px] h-auto rounded-lg  object-contain "
            />
          </div>
          <div
            className={`flex items-center xl:gap-6 ${isInView ? "animate-slide-in-left" : ""}`}
          >
            <img
              src={Founder3}
              alt="Kartik Verma"
              className="w-[280px] lg:w-[340px] xl:w-[520px] h-auto rounded-lg object-contain grayscale"
            />
          </div>
        </div>
      </div>
        ...
        <div className="flex gap-6 lg:gap-[16rem] xl:gap-[27rem] relative">
          ...
          >
            <img
              src={ManishPandey}
              alt="Kartik Verma"
              className="w-[300px] lg:w-[400px] xl:w-[460px] mt-10 h-auto rounded-lg object-contain"
            />
          </div>
          <div
            className={`flex items-center xl:gap-6 ${isInView ? "animate-slide-in-left" : ""}`}
          >
            <img
              src={Founder1}
              alt="Anubhav Dubey"
              className="w-[350px] grayscale md:w-[350px] lg:w-[350px] xl:w-[410px]  h-auto rounded-lg object-contain"
            />
          </div>
        </div>
      </div>
