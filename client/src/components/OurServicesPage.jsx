...
const OurServicesPage = () => {
    ...
    const [sectionRef, sectionInView] = useInView({ threshold: 0.1 });
    const [activeIndex, setActiveIndex] = useState(null); // <-- Track clicked service
                    ...
                    {services.map((service, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className="group cursor-pointer transition-all duration-300 ease-out flex flex-col"
                                onClick={() => setActiveIndex(index)} // <-- set active
                            >
                                <div className="space-y-3">
                                    {/* Number */}
                                    <div
                                        ...
                                        style={{
                                            ...
                                            animationDelay: `${index * 0.1}s`,
                                            animationFillMode: "both",
                                            WebkitTextStroke: isActive ? "0px transparent" : "0.5px #ffffff",
                                        }}
                                    >
                                        {service.number}
                                    </div>
