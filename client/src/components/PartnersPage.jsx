...
const PartnersPage = () => {
    ...
    return (
        ...
        >
            ...
            {/* Stats */}
            <div
                className="flex flex-col md:flex-row justify-center items-center bg-black overflow-hidden z-[0] gap-4 sm:gap-6 md:gap-[200px] lg:gap-[590px] xl:gap-[640px] mb-10"
            >
                {/* Box 1 */}
                <div
