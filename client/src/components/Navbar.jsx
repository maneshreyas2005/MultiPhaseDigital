...
//                         }}>
//                             <ul className="flex flex-col mt-4 font-xs lg:flex-row lg:items-center lg:space-x-0 lg:mt-0">
//                                 <li className="flex items-center">
//                                     <a
//                                         href="#"
//                                         onClick={() => setActiveTab("Home")}
//                                         className={`
//       relative block py-2 pl-3 pr-4 lg:p-3 transition-colors duration-200
//       ${activeTab === "Home" ? "text-white" : "text-gray-300 hover:text-pink-400"}
//     `}
//                                     >
//                                         Home Page
//                                         {/* gradient underline only when active */}
//                                         {activeTab === "Home" && (
//                                             <span className="absolute bottom-0 left-0 w-[5rem] h-[2px] ml-[1rem] rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 shadow-[0_0_12px_2px_rgba(255,115,139,0.6)]"></span>
//                                         )}
//                                     </a>
