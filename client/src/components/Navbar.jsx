      ...
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div className="flex items-center lg:order-2">
          ...
          <a
            ...
            style={{
              background:
                "linear-gradient(270deg, #1B192E 0%, #9116E7 39.7%, #FF738B 100%)",
            }}
          >
            Contact Us
          </a>
        ...
        >
          <div
            className="lg:rounded-full px-6 2xl:px-8"
            style={{ backgroundColor: "#050505" }}
          >
            <div
              className="flex bg-gray-800 lg:rounded-full px-4 mt-[10px] 2xl:px-6"
              style={{
              ...
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:items-center lg:space-x-0 lg:mt-0">
                <li className="flex items-center relative">
                  <a
                    ...
                    aria-current={
                      activeTab === "Home Page" ? "page" : undefined
                    }
                  >
                    Home Page
                  </a>
                  {activeTab === "Home Page" && (
                    <div
                      className="absolute bottom-0 left-2 right-7 h-[2px] rounded-t-lg"
                      style={{
                        background:
                          "linear-gradient(270deg, #1B192E 0%, #9116E7 39.7%, #FF738B 100%)",
                      }}
                ...
                <li className="flex items-center relative">
                  ...
                  {activeTab === "Services" && (
                    <div
                      className="absolute bottom-0 left-2 right-8 h-[2px] rounded-t-lg"
                      style={{
                        background:
                          "linear-gradient(270deg, #1B192E 0%, #9116E7 39.7%, #FF738B 100%)",
                      }}
                ...
                <li className="flex items-center relative">
                  ...
                  {activeTab === "Testimonial" && (
                    <div
                      className="absolute bottom-0 left-3 right-6 h-[2px] rounded-t-lg"
                      style={{
                        background:
                          "linear-gradient(270deg, #1B192E 0%, #9116E7 39.7%, #FF738B 100%)",
                      }}
                ...
                <li className="flex items-center relative">
                  ...
                  {activeTab === "Our Presence" && (
                    <div
                      className="absolute bottom-0 left-3 right-7 h-[2px] rounded-t-lg"
                      style={{
                        background:
                          "linear-gradient(270deg, #1B192E 0%, #9116E7 39.7%, #FF738B 100%)",
                      }}
                ...
                <li className="flex items-center relative">
                  ...
                  {activeTab === "Our Team" && (
                    <div
                      className="absolute bottom-0 left-2 right-0 h-[2px] rounded-t-lg"
                      style={{
                        background:
                          "linear-gradient(270deg, #1B192E 0%, #9116E7 39.7%, #FF738B 100%)",
                      }}
